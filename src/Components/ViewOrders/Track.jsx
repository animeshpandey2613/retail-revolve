    ...
    <div className="fixed w-screen flex justify-center items-center h-screen top-0 left-0 z-50 text-white">
      ...
      >
        <div className="h-full flex flex-col justify-around w-2/5">
          <div className="text-2xl">Update Tracking Details</div>
          <div className="ml-5 flex flex-col gap-3">
            <div className="flex items-center gap-3">
              <div className="">New Dilevery Status:</div>
              <input
                type="text"
            ...
            <div className="flex items-center gap-3">
              <div className="">Retailer Name:</div>
              <div>Debroglie Kirana store</div>
            </div>
            <div className="flex items-center gap-3">
          ...
          <div>
            <div className=" cursor-pointer hover:text-white hover:bg-green-600 duration-700 rounded-md text-green-300 p-3 border-3 flex justify-center items-center border-green-500">
              Update Detail
            </div>
          </div>
        </div>
