                  ...
                  <div className="h-5/6 flex justify-around">
                    ...
                    <div className="w-max justify-between flex">
                      <div>
                        ...
                        <div className="text-green-500 bg-[rgba(0,100,0,0.2)] hover:bg-[rgba(0,100,0,0.5)] hover:text-white duration-700  mt-2 p-2 border-2 border-white rounded-xl flex items-center justify-center cursor-pointer">
                          Buy It again
                        </div>
                      </div>
                    </div>
                    <div className="flex flex-col gap-2">
                      ...
                      <div onClick={()=>setTrackerVisible(true)} className="p-2 border-2 border-white rounded-xl flex items-center justify-center cursor-pointer">
                        Track Order
                      </div>
                    </div>
                  </div>
