  ...
  return (
    <div className="w-screen flex justify-center text-white mb-14">
      <div className=" flex flex-col items-center w-[85vw] min-h-[100vh] bg-[rgba(255,255,255,0.1)] overflow-hidden rounded-3xl backdrop-blur-lg">
                  ...
                  <div className="max-w-72">
                    ...
                    <ul className="text-xs list-disc">
                      <li>
                        ...
                        oils in 1, rice bran oil and sunflower oil, ensures a
                        good balance of MUFA, PUFA for better heart health in
                      ...
                      <li>
                        With LOSORB Technology so that food absorbs upto 33%
                        less oil as compared to other commonly used cooking
                        oils, basis frying studies on potato, 2021
                      </li>
                    </ul>
                  </div>
                </div>
        ...
        <div className="text-xl mb-4 duration-700 border-yellow-700 b-2 p-2 border-2 mt-2 rounded-xl text-center hover:bg-yellow-100 cursor-pointer hover:text-yellow-700">
          Go to Cart
        </div>
      </div>
    </div>
